    ...
    public Map<String, Object> getAccountBalance() {
        ...
        try {
            ...
            for (String key : content) {
                ...
                String command1 = "/Users/adityatiwari/bitgo/bitgo-admin/bin/bgadmin coin trx:usdt";
                String command2 = "/Users/adityatiwari/bitgo/bitgo-admin/bin/bgadmin w " + key;
                String command3 = "/Users/adityatiwari/bitgo/bitgo-admin/bin/bgadmin wallet get " + key;
                String command4 = "/Users/adityatiwari/bitgo/bitgo-admin/bin/bgadmin wallet tx --state confirmed --limit=1000";
...
//                    String url1 = "https://apilist.tronscanapi.com/api/internal-transaction?limit=10000&start=0&address=" + rootAddress;
                    ...
                    String url = "https://apilist.tronscanapi.com/api/token_trc20/transfers?limit=100000000&start=0&contract_address=TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t&toAddress=" + rootAddress;
                    String url1 = "https://apilist.tronscanapi.com/api/token_trc20/transfers?limit=100000000&start=0&contract_address=TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t&fromAddress=" + rootAddress;
...
//                    System.out.println("Count: " + count);
                    ...
                    System.out.println("txid Array");
                    System.out.println(txidArray.length);
                    for(String s:txidArray){
                        System.out.println(s);
                    }
                    JSONArray dataArray = transactions.getJSONArray("token_transfers");
                    JSONArray dataArray2 = transactions1.getJSONArray("token_transfers");
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        if(token.equals("Tether USD") && !dataObject.has("trigger_info")){
                            String txID = dataObject.getString("transaction_id");
                            boolean found = false;
                    ...
                    for (int ii = 0; ii < dataArray2.length(); ii++) {
                        ...
                        String token1 = dataObject1.getJSONObject("tokenInfo").getString("tokenName");
                        if(token1.equals("Tether USD") && !dataObject1.has("trigger_info")){
                            String txID = dataObject1.getString("transaction_id");
                            boolean found = false;
                            for (String txid : txidArray) {
                                if (txID.equals(txid)) {
                                    found = true;
